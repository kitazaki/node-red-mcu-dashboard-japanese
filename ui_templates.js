...
function buildTheme(theme) {
	...
	const result = {
		...
		skins: {},
		styles: {
			chartNoData: new Style({ font:"Noto-Regular", color:halfGray, horizontal:"center" }),
			chartX: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"center" }),
			chartY: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"right" }),
			notification: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"left", left:10, right:10, top:10, bottom:10 }),
			keyboard: new Style({ font:"Noto-Regular", color:BLACK }),
			textName: new Style({ font:"Noto-Regular", color:widgetText, left:5, right:5 }),
			textValue: new Style({ font:"Noto-Regular", color:widgetText, left:5, right:5 }),
			textNameLeft: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"left", left:10 }),
			textValueLeft: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"left", left:10 }),
			textNameRight: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"right", right:10 }),
			textValueRight: new Style({ font:"Noto-Regular", color:widgetText, horizontal:"right", right:10 }),
			textField: new Style({ font:"Noto-Regular", color:[TRANSPARENT,widgetText,widgetText,widget], horizontal:"left", left:10 }),
		},
		textures: {
		}
	};
	...
	result.styles.title = new Style({ font:"Noto-Regular", color:WHITE, horizontal:"left" });
	...
	result.styles.titleMenuItem = new Style({ font:"Noto-Regular", color:[halfGray,groupText,groupText,WHITE], horizontal:"left" });
	...
	result.styles.group = new Style({ font:"Noto-Regular", color:[groupText,groupText,groupText,groupText], horizontal:"left" });
	...
	result.styles.button = new Style({ font:"Noto-Regular", color:[halfGray,WHITE,WHITE,WHITE] });
...
// 	result.skins.dropDown = new Skin({ texture:textures.popup, color:[TRANSPARENT,TRANSPARENT,TRANSPARENT,widget], x:0, y:0, width:60, height:60, left:20, right:20, top:20, bottom:20 });
	...
	result.styles.dropDown = new Style({ font:"Noto-Regular", color:[halfGray,widgetText,widgetText,WHITE], horizontal:"left", left:10 });
	...
	result.styles.dropDownMenuItem = new Style({ font:"Noto-Regular", color:[halfGray,widgetText,widgetText,WHITE], horizontal:"left", left:10 });
...
class REDButtonBehavior extends REDBehavior {
	...
	onCreate(container, data) {
		...
		if (color) {
			container.first.style = new Style({ font:"Noto-Regular", color:[REDTheme.colors.halfGray,color,color,color] });
		}
		if (bgcolor || color) {
